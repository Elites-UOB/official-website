...
// --------------------
const $id_EGXJTUkoo5 = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const _sfc_main = {}
const __vite_ssr_import_0__ = await __vite_ssr_import__("vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${__vite_ssr_import_1__.ssrRenderAttrs(__vite_ssr_import_0__.mergeProps({ class: "bg-slate-300 p-4 rounded w-88" }, _attrs))}><div class="cursor-pointer relative p-5 group bg-white border-t-[12px] rounded-lg transition-all duration-200 delay-100 ease-in-out hover:shadow-xl hover:shadow-secondary-100"><div class="flex flex-col"><div><img src="https://img.freepik.com/premium-vector/programing-concept-program-code-white-isolated-background_197170-769.jpg?w=2000" alt="ll" class="w-77 h-44 rounded-lg"></div><h1 class="text-xl font-bold flex justify-center text-gray-600 group">`)
  __vite_ssr_import_1__.ssrRenderSlot(_ctx.$slots, "title", {}, null, _push, _parent)
  _push(`<!-- <div class="flex items-center">
                        <input type="text" x-show="name"
                            class="block w-full p-2 text-sm text-gray-700 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                            required>
                    </div> --></h1><div class="text-xl tracking-tight text-gray-900">`)
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_j7pm9P2u7Q = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
...
// - /@id/__x00__plugin-vue:export-helper ($id_eFZ80lXORx)
// --------------------
const $id_hgeRbx9wtx = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const __vite_ssr_import_0__ = await __vite_ssr_import__("/node_modules/@nuxt/content/dist/runtime/components/ContentDoc.mjs");
...
const __modules__ = {
  ...
  "/components/content/Card.vue": $id_EGXJTUkoo5,
  ...
  "/pages/[...slug].vue?macro=true": $id_j7pm9P2u7Q,
  "/pages/CardDetails.vue": $id_2RDDM7mI92,
  "/pages/[...slug].vue": $id_hgeRbx9wtx,
