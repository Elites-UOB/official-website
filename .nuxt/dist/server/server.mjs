...
// --------------------
const $id_UEpa4uYDQQ = async function (global, module, exports, __vite_ssr_exports__, __vite_ssr_import_meta__, __vite_ssr_import__, __vite_ssr_dynamic_import__, __vite_ssr_exportAll__) {
const _sfc_main = {}
const __vite_ssr_import_0__ = await __vite_ssr_import__("vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${__vite_ssr_import_1__.ssrRenderAttrs(__vite_ssr_import_0__.mergeProps({ class: "bg-slate-300 p-4 rounded w-88 flex w-full h-full grid grid-rows-3" }, _attrs))}><!--[-->`)
  __vite_ssr_import_1__.ssrRenderList(10, (index) => {
    _push(`<div class="m-9 cursor-pointer relative p-5 group bg-white border-t-[12px] rounded-lg transition-all duration-200 delay-100 ease-in-out hover:shadow-xl hover:shadow-secondary-100"><div class="flex flex-col"><div><img src="https://img.freepik.com/premium-vector/programing-concept-program-code-white-isolated-background_197170-769.jpg?w=2000" alt="img" class="w-77 h-44 rounded-lg"></div><div class="text-xl font-bold flex justify-center text-gray-600 group">`)
...
const __modules__ = {
  ...
  "/components/content/Card.vue": $id_UEpa4uYDQQ,
