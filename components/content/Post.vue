<template>
    <div flex="~ col gap-1rem" w="full">
        ...
        <a v-if="person" :href="person.link" decoration="none" cursor="pointer" flex="~ gap-1rem" bg="hover:light hover:opacity-10" p="y-2 x-4" w="fit" text="20px mid" items="center">
